      ...
      {shouldPlayIntro ? (
        ...
        >
          ...
          <SuccessiveType
            onEnd={onIntroEnd}
            words={
              "In the face of adversity, I have navigated storms that sought to drown my spirit, endured shadows that aimed to dim my light, and faced countless obstacles that tried to bring me down. No matter how heavy the burdens I've carried, I have learned to stand tall amid the chaos, embracing my strength and unwavering spirit. And still I rise!"
            }
            speed={1}
